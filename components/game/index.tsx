...
export default function Gameplay() {
  ...
  const items = [
    ...
    ["/images/item1.svg", "/images/item1.svg", "/images/item1.svg"],
    ["/images/item1.svg"],
    ["/images/item1.svg", "/images/item1.svg", "/images/item1.svg", "/images/item1.svg", "/images/item1.svg"],
  ]
  ...
  return <Body>
    ...
    {raiseshow ?
      ...
      <>
        ...
        <Box display="flex" justifyContent="center" onClick={() => setIsSetting(!issetting)}>
          <Progress>
