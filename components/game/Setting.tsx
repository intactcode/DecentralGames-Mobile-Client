            ...
            <SettingField>
                ...
                <Box display="flex" justifyContent="space-between">
                    <Progress justifyContent="none!important">
                        ...
                        <ProgressBar type={0} percent={7 / 15} text="7 of 15" width="179px" />
                    </Progress>
                ...
                <BottomSetting >
                    <Box>
                        ...
                        <ItemField type={1}>
                            <Box>- -&nbsp;&nbsp;</Box>
                            <Box mt="5px"><img src="/images/diamond.svg" width="18px" height="18px" /></Box>
                        </ItemField>
                    </Box>
                    <Box>
                        <Box> Net Chips</Box>
                        <ItemField type={2}>
                            <Box>+0</Box>
                            <Box mt="5px"><img src="/images/freecoin.svg" width="18px" height="18px" /></Box>
                        </ItemField>
